...
class _JoinVolunteerScreenState extends State<JoinVolunteerScreen> {
  ...
  Widget _buildSelectedAvailabilityCard(
      String availability, List<String> options) {
    return Card(
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(12),
      ),
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (selectedTrust != null &&
                            ...
                            Align(
                              ...
                              child: Text(
                                "Select Availability",
                                style:
                                TextStyle(color: AppColors.primaryPink),
                              ),
                            ),
                            Wrap(
                              spacing: 12,
                              ...
                              children: availabilityOptions.map((day) {
                                final isSelected =
                                selectedAvailabilitySlots.containsKey(day);
                                final isCurrentlyEditing =
                                    currentlySelectedAvailability == day;

                                final hasSlots = (selectedAvailabilitySlots[day]?.isNotEmpty ?? false);
                                return Container(
                                  constraints: BoxConstraints(
                                    minWidth: 80,
                                    maxWidth:
                          ...
                          if (currentlySelectedAvailability != null &&
                              currentlySelectedAvailability!.isNotEmpty) ...[
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Select Slot",
                          ...
                          if (selectedData['availabilities'].isNotEmpty) ...[
                            ...
                            ...selectedData['availabilities']
                                .entries
                                .map((entry) {
                              return _buildSelectedAvailabilityCard(entry.key,
