...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final fieldWidth = screenWidth * 0.85; // responsive width
    final buttonWidth = screenWidth * 0.82; // responsive button
                              ...
                              SizedBox(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        "I consent to secure UPI donations and account verification process.",
                                        style: TextStyle(fontSize: 15),
                                      ),
                                    ),
                                  ],
                                ...
                                onTap: () {
                                  ...
                                  if ((!_policy || !_upiConsent) && email.isEmpty) {
                                    ToastService.showError(context,
                                        "Please Enter the email as well as check the term & condition boxes!");
                                  } else if (!_policy || !_upiConsent) {
                                    ToastService.showError(context,
                                        "Please agree to the Terms and give UPI consent.");
                                  } else if (email.isEmpty) {
                                    ToastService.showError(
                                        context, "Please Enter the email!");
                                  } else {
                                    if (_emailRegex.hasMatch(email)) {
                                      _sendOtp();
                                    } else {
              ...
              if (isLoading)
                Positioned.fill(
                  child: Container(
                    ...
                    child: Center(
                      child: LoaderScreen(
                          txtDisplay: "Verifying your email..."),
                    ),
                  ),
                ),
            ],
...
Widget loginBtn(double buttonWidth) {
  return Container(
    width: buttonWidth,
    height: 55,
    decoration: BoxDecoration(
